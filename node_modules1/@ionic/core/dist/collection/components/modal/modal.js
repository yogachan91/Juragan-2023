...
export class Modal {
  ...
  render() {
    ...
    return (h(Host, Object.assign({ "no-router": true, "aria-modal": "true", role: "dialog", tabindex: "-1" }, htmlAttributes, inheritedAttributes, { style: {
      ...
      h("div", { class: "modal-wrapper ion-overlay-wrapper", part: "content", ref: (el) => (this.wrapperEl = el) },
        showHandle && (h("button", { class: "modal-handle", 
          // Prevents the handle from receiving keyboard focus when it does not cycle
          tabIndex: !isHandleCycle ? -1 : 0, "aria-label": "Activate to adjust the size of the dialog overlaying the screen", onClick: isHandleCycle ? this.onHandleClick : undefined, part: "handle" })),
        h("slot", null))));
  }
