...
@Component({
  selector: 'app-redeem-detail-electronic',
  templateUrl: './redeem-detail-electronic.page.html',
  styleUrls: ['./redeem-detail-electronic.page.scss'],
})
export class RedeemDetailElectronicPage implements OnInit {
  ...
  tukarpoint(){
    let navigationExtras: NavigationExtras = { state: { item: this.item, balance: this.balance} };
