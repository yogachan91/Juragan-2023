...
@Component({
  ...
  templateUrl: './redeem-now.page.html',
  styleUrls: ['./redeem-now.page.scss'],
})
export class RedeemNowPage implements OnInit {
  item: any;
  balance: any;
  poin=0;
  qty= 1;
  ...
  ngOnInit() {
    ...
    console.log('cektyper',this.type_r);
