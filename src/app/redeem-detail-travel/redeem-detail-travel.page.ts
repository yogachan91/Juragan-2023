...
@Component({
  selector: 'app-redeem-detail-travel',
  templateUrl: './redeem-detail-travel.page.html',
  styleUrls: ['./redeem-detail-travel.page.scss'],
})
export class RedeemDetailTravelPage implements OnInit {
  item: any;
  balance: any;
  constructor(
  ...
  tukarpoint(){
    let navigationExtras: NavigationExtras = { state: { item: this.item, balance: this.balance,type_r:'travel'} };
